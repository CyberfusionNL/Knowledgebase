        ...
        <div class="container">
            <div class="row align-items-center">
                <div class="col-md-3 d-flex align-items-center">
                    ...
                    <svg class="hamburger" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 8 8">
                ...
                <div class="col-md-9">
                    ...
                    <nav class="nav float-right align-items-center">
                        ...
                        @endguest
                        <a class="nav-link" href="https://cyberfusion.nl">naar cyberfusion.nl</a>
                    </nav>
                    <svg class="close" xmlns="http://www.w3.org/2000/svg" width="8" height="8" viewBox="0 0 8 8">
